...
- this will be developed on the branch `11-footer`.
...
- this will be on `volunteers.html` web pages.
- this will be developed on the branch `13-volunteerbtn`.
...
- this will be developed on the branch `14-donate`.
...
- [ ] _there is a section on homepage with logos/links of the partner
      organizations_
- this will be on `index.html` web page.
- this will be developed on the branch `15-partner`.
...
- this will be developed on the branch `16-projects`.
